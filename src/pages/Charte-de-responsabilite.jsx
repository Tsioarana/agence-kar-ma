...
const Charteresponsabilite = () => {
  return (
    <div className="audace-user" style={{textAlign: 'center', marginTop: '70px'}}>
      <h1>Notre charte de responsabilité</h1>
      <p>Kar’Ma est une agence de production responsable, qui s’engage à promouvoir et à développer les initiatives solidaires et responsables.</p>
      <p>Nous souhaitons contribuer, à notre échelle, au développement social, solidaire et environnemental de notre société, avec respect et éthique.</p>
      
      <img src={chart} alt="" style={{maxWidth: '200px', marginBottom: '50px'}} />

      <h1>Voici nos engagements et notre raison d’être :</h1>
...
export default Charteresponsabilite;
